			...
			<?php 
				foreach ($alumnos as $dato) {
					...
					<tr>
						...
						<td><a class="editar" href="editar.php?id=<?php echo $dato->id_alumno; ?>">Editar</a></td>
						<td><a class="eliminar" href="eliminar.php?id=<?php echo $dato->id_alumno; ?>">Eliminar</a></td>
					</tr>
					<?php
				}
			?>
